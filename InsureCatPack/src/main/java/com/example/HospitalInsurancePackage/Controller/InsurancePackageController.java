...
public class InsurancePackageController {
	...
	public String addhospital(@RequestParam String title, String desc, String status, String rangeStart,
			String rangeEnd, String ageLimitStart, String ageLimitEnd, Model model) {

		InsurancePackage insp = new InsurancePackage(0, title, desc, status, Double.parseDouble(rangeStart),
				Double.parseDouble(rangeEnd), Integer.parseInt(ageLimitStart), Integer.parseInt(ageLimitEnd));
		
		insurancePackageRepository.addPackage(insp);
