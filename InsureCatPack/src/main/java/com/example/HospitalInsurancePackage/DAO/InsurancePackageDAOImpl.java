...
//------------------------------------------------------------------------------------
	...
	public void addPackage(InsurancePackage insp) {
		...
		String stmt = "INSERT INTO InsurancePackages (insp_title, insp_desc, insp_status, insp_range_start, insp_range_end, insp_agelimit_start, insp_agelimit_end, insp_cdate) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		jdbcTemplate.query(stmt, insp.getInspTitle(), insp.getInspDescription(), insp.getInspStatus(), insp.getInspRangeStart(), insp.getInspRangeEnd(), insp.getInspAgeLimitStart(), insp.getInspAgeLimitEnd(), utilDate);
	}
}
